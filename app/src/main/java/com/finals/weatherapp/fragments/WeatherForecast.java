...
public class WeatherForecast extends Fragment {
    ...
    private void getForecastDetails() {
        ...
        String apiURL = "https://api.openweathermap.org/data/2.5/onecall?lat=" + latitude + "&lon=" + longitude + "&exclude=current,minutely,hourly,alerts&appid=" + BuildConfig.API_KEY;
